...
I copied and pasted `cs15lwi24` to begin work in the course. Then I copied the lab7 SSH link from my Github browser and pasted it after writing `git clone ` to clone my fork of the repository.
